...
- 远程代码选择 No；
- 隐私政策填写 `https://rmqg.github.io/bilibili-history-wxt/privacy-policy/`。
...
6. Properties 中个人信息选择 Yes；隐私政策使用 Edge 专用地址
   `https://rmqg.github.io/bilibili-history-wxt/privacy-policy/edge/`。
7. Website URL 填 `https://rmqg.github.io/bilibili-history-wxt/`，Support contact details 填
   `https://rmqg.github.io/bilibili-history-wxt/support/`。
...
```text
https://rmqg.github.io/bilibili-history-wxt/privacy-policy/
https://rmqg.github.io/bilibili-history-wxt/privacy-policy/edge/
https://rmqg.github.io/bilibili-history-wxt/support/
```
